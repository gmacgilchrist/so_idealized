...
curl -u 'gmacgilchrist' https://api.github.com/user/repos -d '{"name":"so_idealized", "private":false}'
...
git remote add origin git@github.com:gmacgilchrist/so_idealized.git
